...
public class MathinterpreterPackageImpl extends EPackageImpl implements MathinterpreterPackage
{
   ...
   */
  @Override
  public EReference getDefineExpr_Expression()
  {
    return (EReference)defineExprEClass.getEStructuralFeatures().get(1);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(defineExprEClass, DEFINE_EXPR__EXPRESSION);
  ...
  public void initializePackageContents()
  {
    ...
    variableDefinitionEClass.getESuperTypes().add(this.getMathExpression());
    ...
    primaryEClass.getESuperTypes().add(this.getMDExpression());
    ...
    initEReference(getVariableDefinition_Variable(), this.getVariable(), null, "variable", null, 0, 1, VariableDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(functionEClass, Function.class, "Function", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getFunction_Expression(), this.getPMExpression(), null, "expression", null, 0, 1, Function.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getDefineExpr_Expression(), this.getPMExpression(), null, "expression", null, 0, 1, DefineExpr.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
