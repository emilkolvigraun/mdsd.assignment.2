 ...
 *   <li>{@link org.xtext.assingment2.mathinterpreter.impl.DefineExprImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DefineExprImpl extends MathExpressionImpl implements DefineExpr
{
  ...
  public NotificationChain basicSetExpression(PMExpression newExpression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MathinterpreterPackage.DEFINE_EXPR__EXPRESSION, oldExpression, newExpression);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setExpression(PMExpression newExpression)
  {
    if (newExpression != expression)
    {
      NotificationChain msgs = null;
      if (expression != null)
        msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MathinterpreterPackage.DEFINE_EXPR__EXPRESSION, null, msgs);
      if (newExpression != null)
        msgs = ((InternalEObject)newExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MathinterpreterPackage.DEFINE_EXPR__EXPRESSION, null, msgs);
      msgs = basicSetExpression(newExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MathinterpreterPackage.DEFINE_EXPR__EXPRESSION, newExpression, newExpression));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case MathinterpreterPackage.DEFINE_EXPR__EXPRESSION:
