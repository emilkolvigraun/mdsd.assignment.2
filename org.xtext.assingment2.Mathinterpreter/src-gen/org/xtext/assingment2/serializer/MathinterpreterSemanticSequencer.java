...
public class MathinterpreterSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == MathinterpreterPackage.eINSTANCE)
			...
			case MathinterpreterPackage.VARIABLE:
				...
				return; 
			case MathinterpreterPackage.VARIABLE_DEFINITION:
	 ...
	 *
	 * Constraint:
	 *     (variables+=Variable variables+=Variable* expression=PMExpression)
	 */
	...
	protected void sequence_Function(ISerializationContext context, Function semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, MathinterpreterPackage.Literals.FUNCTION__EXPRESSION) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MathinterpreterPackage.Literals.FUNCTION__EXPRESSION));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getFunctionAccess().getExpressionPMExpressionParserRuleCall_2_0(), semanticObject.getExpression());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (left=MDExpression_MDExpression_1_0 operator=MultiplyDivide right=Primary)
	 */
	protected void sequence_MDExpression(ISerializationContext context, MDExpression semanticObject) {
		...
		feeder.accept(grammarAccess.getMDExpressionAccess().getRightPrimaryParserRuleCall_1_2_0(), semanticObject.getRight());
		feeder.finish();
	}
	...
	/**
	 * Contexts:
	 *     MathExpression returns VariableDefinition
	...
	protected void sequence_VariableDefinition(ISerializationContext context, VariableDefinition semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, MathinterpreterPackage.Literals.VARIABLE_DEFINITION__VARIABLE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MathinterpreterPackage.Literals.VARIABLE_DEFINITION__VARIABLE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getVariableDefinitionAccess().getVariableVariableParserRuleCall_1_0(), semanticObject.getVariable());
		feeder.finish();
	}
